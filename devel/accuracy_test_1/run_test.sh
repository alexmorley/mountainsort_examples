...
mlp-run synthesize_v1.mlp synthesize --samplerate=30000 --duration=60 --timeseries=data/raw.mda --geom=data/geom.csv --waveforms_true=data/waveforms_true.mda --firings_true=data/firings_true.mda --num_channels=10 --num_units=50
